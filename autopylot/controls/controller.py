...
from ..utils import memory, utils, settings

try:
    import keyboard
except ImportError:
    logging.warning("not support for keyboard module.")
...
class KeyboardController:
    """Keyboard controller (debugging purpose)."""
...
def Controller(
    ...
    **kwargs,
    ...
    if controller_type == "xbox":
        ...
        return KeyboardController(memory=memory, *args, **kwargs)
    else:
