...
\begin{figure}[h]
    ...
    \subfloat[Model MickaelB]{%
        \includegraphics[height=0.49\textheight]{../../docs/model-micka.png.png}%
        \label{fig:a}%
        }%
...
Firstly, we created X and Y which are lists of lists of numpy array. Then we had to pick randomly some paths according to the batch size. Secondly, thanks to the previous function load_image_data, we can load the data of the image using a path 
